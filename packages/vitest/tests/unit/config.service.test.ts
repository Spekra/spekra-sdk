...
describe('ConfigService', () => {
  ...
  describe('resolve', () => {
    it('uses option values over env vars', () => {
      process.env.SPEKRA_VITEST_API_KEY = 'env-key';
      process.env.SPEKRA_VITEST_SOURCE = 'env-source';
    ...
    it('uses SPEKRA_VITEST_* env vars', () => {
      process.env.SPEKRA_VITEST_API_KEY = 'vitest-key';
      process.env.SPEKRA_VITEST_SOURCE = 'vitest-source';
      process.env.SPEKRA_VITEST_API_URL = 'https://custom.api.com';

      const config = ConfigService.instance().resolve({});

      expect(config.apiKey).toBe('vitest-key');
      expect(config.source).toBe('vitest-source');
    ...
    it('prefers SPEKRA_VITEST_* over SPEKRA_*', () => {
      process.env.SPEKRA_API_KEY = 'fallback-key';
      process.env.SPEKRA_VITEST_API_KEY = 'vitest-key';
    ...
    it('resolves boolean from env var string', () => {
      process.env.SPEKRA_VITEST_ENABLED = 'false';
      process.env.SPEKRA_VITEST_DEBUG = 'true';
    ...
    it('resolves boolean 0 as false', () => {
      process.env.SPEKRA_VITEST_ENABLED = '0';
